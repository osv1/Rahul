var app = angular.module("app", ['ui.router', 'ngBootbox','ngResource', 'ng-sweet-alert', 'toastr', 'angularUtils.directives.dirPagination', 'ngFileUpload', 'ngMessages']);
...
app.controller('askController', function($scope, $http, Upload, $window, $ngBootbox,SweetAlert, $location, toastr, $stateParams, $resource, userService) {
