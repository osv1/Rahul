...
exports.getAtask = function(req, res)
  {
    ...
    taskm.find({'_id':id}).exec(function (err, result) {
    if (err) 
      {
        res.json({code:400,message:"error"})
      }
...
exports.edittask = function(req, res){
  console.log("updatetask", req.params.id, req.body); 
 taskm.update({_id: req.params.id}, { $set: req.body }).exec (function(err, taskm){ 
